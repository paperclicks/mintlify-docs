...
<Note>
  If your tracker is not on the supported list, you can use the Google Sheets or Custom Data Source integration as a workaround.

  - Export your conversion data to a Google Sheet and TheOptimizer will sync from it automatically every 30 minutes.
  - Use our Custom Data Source integration to upload your conversion, revenue or any other custom data using our API
</Note>
