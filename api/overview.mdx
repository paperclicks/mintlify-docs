...
All API requests require a valid API key passed in the request headers. You can find your API key in TheOptimizer under **Settings → API**.

## Base URL

```
https://api.theoptimizer.io
```
