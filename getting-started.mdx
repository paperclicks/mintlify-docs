---
title: "Get Started with TheOptimizer in Five Steps"
description: "Follow five steps to connect ad networks and trackers, explore the Campaigns view, configure automation rules, and launch your first campaigns at scale."
...
<Steps>
  ...
  <Step title="Connect a Tracking Platform (Optional)">
    ...
    If your tracker is not on the supported list, you can use the **Google Sheets or CSV integration** as a workaround — export your conversion data to a Google Sheet and TheOptimizer will sync from it automatically every 30 minutes. You can also upload a CSV file manually or push one via API.
