---
title: "Filtering Campaigns & Saving Views"
description: "Search and filter campaigns, ad sets, and ads by any metric or attribute — then save filter combinations as one-click views."
---

The filtering bar sits below the Totals Bar and lets you search and filter campaigns, ad sets, or ads by virtually any metric or attribute. Click the **Search filters...** box to open the filter panel, or press **Cmd+K** / **Ctrl+K** from anywhere in the view.
...
The filtering system is built for keyboard-first workflows:
