...
<Steps>
  <Step title="Get Your Template">
    ...
    <Frame>
      <img src="/images/revcontent/campaign-uploader/revcontent-campaign-creator-selection.png" alt="New RevContent Campaign — choose Create Manually or Bulk Upload (Excel)" />
    </Frame>
    ...
    **Option A — Download pre-filled from an existing campaign (recommended)**
    ...
    <Frame>
      <img src="/images/revcontent/campaign-uploader/revcontent-excel-uploader-modal.png" alt="RevContent Bulk Upload modal — Reference campaign dropdown, Copy template button, and file upload area" />
    </Frame>
