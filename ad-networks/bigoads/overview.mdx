---
title: "BigoAds on TheOptimizer"
description: "Connect BigoAds to TheOptimizer to monitor performance, automate optimization, and manage campaigns from one dashboard."
...
<CardGroup cols={2}>
  <Card title="Connect BigoAds" icon="link" href="/ad-networks/bigoads/integration/connect">
    You connect it using API credentials generated from the network's own settings.
  </Card>
  <Card title="Manage ad accounts" icon="sliders" href="/ad-networks/bigoads/integration/manage-accounts">
