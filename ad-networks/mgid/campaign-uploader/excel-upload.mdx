...
<Steps>
  <Step title="Get Your Template">
    ...
    <Frame>
      <img src="/images/mgid/campaign-uploader/mgid-campaign-creator-selection.png" alt="New MGID Campaign — choose Create Manually or Bulk Upload (Excel)" />
    </Frame>
    ...
    **Option A — Download pre-filled from an existing campaign (recommended)**
    ...
    <Frame>
      <img src="/images/mgid/campaign-uploader/mgid-excel-uploader-modal.png" alt="MGID Bulk Upload modal — Reference campaign dropdown, Copy template button, and file upload area" />
    </Frame>
