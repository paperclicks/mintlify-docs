...
<Steps>
  <Step title="Get Your Template">
    ...
    <Frame>
      <img src="/images/outbrain/campaign-uploader/outbrain-campaign-creator-selection.png" alt="New Outbrain Campaign — choose Create Manually or Bulk Upload (Excel)" />
    </Frame>
    ...
    **Option A — Download pre-filled from an existing campaign (recommended)**
    ...
    <Frame>
      <img src="/images/outbrain/campaign-uploader/outbrain-excel-uploader-modal.png" alt="Outbrain Bulk Upload modal — Reference campaign dropdown, Copy template button, and file upload area" />
    </Frame>
