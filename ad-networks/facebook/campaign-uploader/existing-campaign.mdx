...
<Frame>
  <img src="/images/load-existing-campaign-to-the-FB-launcher.png" alt="Select Ad Account — Use existing campaign tab showing searchable campaign list" />
</Frame>
...
<Frame>
  <img src="/images/existing-ad-set-options.png" alt="Ad set context menu — Create Ad, Clone Ad Set, Copy Ad Set, Copy All Ads, and FB ID options" />
</Frame>
