...
<Frame>
  <img src="/images/automatic-placement-matching-by-file-name.png" alt="Select Images dialog — Auto-match by filename toggle at the bottom, enabled, with images named with aspect ratios" />
</Frame>
...
<Frame>
  <img src="/images/automatic-placement-matching-by-file-name-next.png" alt="Edit Placements dialog — three placement columns each showing the auto-matched image from the filename" />
</Frame>
...
<Frame>
  <img src="/images/add-tags-during-uploading.png" alt="Select Images dialog — Add Tags button in the top right, highlighted with an arrow" />
</Frame>
