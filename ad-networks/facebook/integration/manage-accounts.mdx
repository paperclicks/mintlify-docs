...
Each ad account is linked to a **profile** — the Facebook login used to access it. You can change which profile is linked to a specific ad account at any time:
  ...
  <ArcadePopoutModal id="uImSQbP30BHmGyqJFDee" title="Connect a new Facebook Profile" />
...
### Add New Profiles
  ...
  <ArcadePopoutModal id="BNj0P8qPYhSblTmaHztu" title="Connect a new Facebook Profile" />
...
<Frame>
  <img src="/images/facebook/facebook_Integrations_sync_ad_accounts.gif" alt="Select Ad Account — Use existing campaign tab showing searchable campaign list" />
</Frame>
...
<Frame>
  <img src="/images/facebook/facebook-mange-profiles-re-authenticate-profile.gif" alt="Select Ad Account — Use existing campaign tab showing searchable campaign list" />
</Frame>
